  ...
  return (
    <section className="text-xl" >
      ...
      <section className="grid gap-4 sm:grid-cols-two">
        ...
        <article className="bg-slate-300/70 rounded-3xl grid grid-cols-3 justify-center py-2 sm:grid-cols-1 sm:px-2 sm:py-0">
      ...
      <button onClick={changeUnitTemp}className="bg-blue-500 py-2 px-6 text-white font-bold rounded-full hover:bg-blue-800 duration-200 text-sm block mx-auto mt-6">Change °C/°F</button>
